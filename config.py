MARKETS = [
    {
        ...
        'company_list': [
            ...
            'MEG', 'MX', 'MRU', 'MNW', 'MSI', 'MTY', 'MTL', 'NA', 'NSU', 'NFI',
            'NGD', 'NXE', 'OSB', 'NPI', 'NVU.UN', 'NG', 'NTR', 'NVA', 'OGC', 'ONEX',
            'OTEX', 'OR', 'PAAS', 'POU', 'PXT', 'PKI', 'PSI', 'PPL', 'PEY', 'POW',
            'PWF', 'PSK', 'PD', 'PBH', 'PVG', 'QBR.B', 'QSR', 'RCH', 'REI.UN', 'RBA',
            'RCI.B', 'RY', 'RUS', 'SSL', 'SAP', 'SES', 'SMF', 'VII', 'SJR.B', 'SCL',
            'SHOP', 'SIA', 'SW', 'ZZZ', 'SRU.UN', 'SNC', 'TOY', 'SSRM', 'STN', 'SJ',
            'SLF', 'SU', 'SPB', 'THO', 'TVE', 'TECK.B', 'T', 'TFII', 'NWC', 'TSGI',
            'TRI', 'X', 'TOG', 'TXG', 'TIH', 'TD', 'TOU', 'TA', 'RNW', 'TRP',
            'TCL.A', 'TCW', 'TCN', 'TRQ', 'UNS', 'VET', 'WCN', 'WFT', 'WEF', 'WJA',
            'WTE', 'WPM', 'WCP', 'WPK', 'WSP', 'YRI'
        ],
